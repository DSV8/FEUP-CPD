...
{
	if (m_ar % bkSize != 0) {
        cout << "\nERROR, M_AR MUST BE A MULTIPLE OF BLOCK SIZE\n" << endl;
        return;
    }
...
void test() {
    ...
    std::cout << "-------------------------------\n";
    std::cout << "|LINE BY COLUMN MULTIPLICATION|\n";
    std::cout << "-------------------------------\n";
    ...
    std::cout << "\n\n-----------------------------\n";
    std::cout << "|LINE BY LINE MULTIPLICATION|\n";
    std::cout << "-----------------------------\n";
    for (int i = 600; i <= 3000; i += 400) {
        std::cout << "\nTESTING FOR MATRIX SIZE OF " << i << "x" << i << "\n";
        std::cout << "------------------------------------\n";
    ...
    std::cout << "----------------------\n";
    int j_values[] = {128, 256, 512};
    for (int i = 4096; i <= 10240; i += 2048) {
        for (int j = 0; j < sizeof(j_values)/sizeof(j_values[0]); j++) {
            std::cout << "\nTESTING FOR MATRIX SIZE OF " << i << "x" << i << "\n";
            std::cout << "BLOCK SIZE = " << j_values[j] << "\n";
            std::cout << "------------------------------------\n";
...
int main (int argc, char *argv[])
{
	...
	do {
		...
		if (op == 0)
			break;
		printf("Dimensions: lins=cols ? ");ret = PAPI_start(EventSet);
	if (ret != PAPI_OK) cout << "ERROR: Start PAPI" << endl;
   		cin >> lin;
   		col = lin;
